				...
				<tbody>
					<tr>
						<th scope="row" colspan="2">
							<input type="text" name="oem_client_nm" id="oem_client_nm" readOnly>
						</th>
						<th scope="row" colspan="2">
					...
					<tr>
						...
						<!-- 목록조회 외에 UPDATE, INSERT , DELETE 등을 위해 필요함  hidden 값  // INT가 아닌것도 있음  -->
						<td hidden="">
							<input type="text" class="inputTxt p100" name="slip_no" id="slip_no" />
						</td>
					...
					<tr>
						<th scope="row">주소</th>
						<td><input type="text" class="inputTxt p100" name="addr" id="addr" readOnly /></td>
						<th scope="row">주소</th>
						<td><input type="text" class="inputTxt p100" name="erp_addr" id="erp_addr" readOnly /></td>
					</tr>
					<tr>
					...
					<tr>
						<td scope="row" colspan="4">
							<br> 1. 귀사의 일익 번창하심을 기원합니다.
							<br> 2.하기와 같이 견적드리오니 검토하기 바랍니다.
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" id="limit_date" name='limit_date' readOnly />
						</td>
					</tr>
