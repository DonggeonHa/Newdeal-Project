...
<!-- 모달팝업 ==  신규 등록 1 -->
<div id="layer1-2" class="layerPop layerType2"  style="width: 1200px;">
	<dl>
		<dt>
			...
			<table class="row">
				...
				<tbody>
					...
					<tr>
						<th scope="row">비고</th>
						<td colspan="5">
							<textarea placeholder="내용을 입력해주세요." id="remarks2" name="remarks2" style="width: 100%; height: 6.25em; border: none; resize: none;"></textarea>
						</td>
					</tr>
				</tbody>
			</table>
				...
				<thead>
					...
					<tr>
						...
						<td style="float: right;">
							<a href="" class="btnType2 color4" id="test" name="btn"><span>추가</span></a>
						</td>
					</tr>
				</thead>
			</table>
			<div class="btn_areaC mt30">
				<a href="" class="btnType blue" id="232323" name="btn"><span>등록</span></a>
