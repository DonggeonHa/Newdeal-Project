...
public class EstListDetailDto {
	...
	public String toString() {
		return "EstListDetailDto [estimateNo=" + estimateNo + ", clientCd=" + clientCd + ", price=" + price + ", tax="
				+ tax + ", unitCost=" + unitCost + ", productCd=" + productCd + ", estimateCnt=" + estimateCnt
				+ ", estimateDate=" + estimateDate + ", clientNm=" + clientNm + ", productNm=" + productNm + "]";
	}
}
