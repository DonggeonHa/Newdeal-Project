...
public class OeManagementModel {
	...
	public String toString() {
		return "OeManagementModel [estimate_no=" + estimate_no + ", estimate_date=" + estimate_date + ", supply_val="
				...
				+ ", cop_no3=" + cop_no3 + ", emp_nm=" + emp_nm + ", emp_hp=" + emp_hp + ", product_nm=" + product_nm
				+ ", estimate_cnt=" + estimate_cnt + ", addr=" + addr + ", addr_detail=" + addr_detail + ", product_cd="
				+ product_cd + ", receive_num=" + receive_num + ", order_date=" + order_date + ", want_receive_date="
				+ want_receive_date + ", order_cnt=" + order_cnt + ", amount=" + amount + ", tax=" + tax
				+ ", warehouse_cd=" + warehouse_cd + ", offline=" + offline + ", deposit_yn=" + deposit_yn + ", STTcd="
				+ STTcd + ", loginID=" + loginID + ", slip_no=" + slip_no + "]";
	}
